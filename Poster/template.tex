...
\begin{block}{Results: Simulation vs Data}
	Using the parameters of transmissibility taking into account weather conditions $\beta_0 =0.48 $ \cite{TALIB2021} and diffusion coefficient of $D = 0.85$. 
	Furthermore, the mean recovery time was assumed to be 14 days.
...
\begin{block}{Results: Figures}
	\begin{figure}
		...
		\caption{Disease spreading over time in Greater Manchester. Using parameters of intial transmission rate $\beta_0 = 0.48$ and diffusion coefficient of$D = 0.85 m^2 s^{-1}$ and a mean recovery time of $\tau = 14 days$. }
	\end{figure}
	\begin{figure}
