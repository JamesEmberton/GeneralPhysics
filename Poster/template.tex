...
\begin{block}{Results: Simulation vs Data}
	Using the parameters of transmissibility taking into account weather conditions $\beta_0 =0.48 $ \cite{2021} and using the spatial density given for each county of Greater Manchester from the March 2021 Census. 
	Put things here
\end{block}
