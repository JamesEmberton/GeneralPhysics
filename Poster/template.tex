...
\begin{block}{Results: Simulation vs Data}
	Infection of COVID-19 was modelled in Greater Manchester with an initial transmissibilty of $\beta_0 =0.48 per day $ taking into account weather effects \cite{TALIB2021}
	...
	The model was compared to the COVID-19 infection map of Boston \cite{KUMAR2021} 
